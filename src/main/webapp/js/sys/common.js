...
path = path.replace("/js/sys/", "");
window.g_path = path;

/*document.write('<script src="' + path + 'js/vue/vue.min.js" type="text/javascript" ></sc' + 'ript>');
document.write('<link href="' + path + 'js/element-ui/index.css" rel="stylesheet" type="text/css" />');
document.write('<script src="' + path + 'js/element-ui/index.js" type="text/javascript" ></sc' + 'ript>');*/
document.write('<script src="' + path + '/js/miniui/boot.js" type="text/javascript" ></sc' + 'ript>');
document.write('<script src="' + path + '/js/crypto-js/crypto-js.js" type="text/javascript" ></sc' + 'ript>');
document.write('<script src="' + path + '/js/plupload/plupload.full.min.js" type="text/javascript" ></sc' + 'ript>');
document.write('<script src="' + path + '/js/sys/inner/ajaxencoder.js" type="text/javascript" ></sc' + 'ript>');
document.write('<script src="' + path + '/js/sys/inner/formfunc.js" type="text/javascript" ></sc' + 'ript>');
document.write('<link href="' + path + '/css/form.css" rel="stylesheet" type="text/css" />');
...
var MsgBox = {
	...
	showInfoTips : function(info){
		...
		this.showTips(content,"info");
	},
	showSuccessTips : function(info){
		var content = "<b>提示</b> <br/>" + info;
		this.showTips(content,"success");
	},
	showWarningTips : function(info){
		var content = "<b>提示</b> <br/>" + info;
		this.showTips(content,"warning");
	},
	showErrTips : function(info){
		var content = "<b>提示</b> <br/>" + info;
		this.showTips(content,"danger");
	}
