...
@LPController(controllerkey="/bianyazhuanbian")
public class zhuanbianController extends Controller  {

	public void index() {
		renderTemplate("/org/zhutineirong/binayazhuanbian_list.html");
	}
	...
	return select ;
		...
		public void edit(){
			...
			renderTemplate("/org/zhutineirong/bianyazhuanbian_edit.html");
		}
		...
		public void onSearcj(){
			renderTemplate("/sea3000/bianyaxuanze.html");
		}
