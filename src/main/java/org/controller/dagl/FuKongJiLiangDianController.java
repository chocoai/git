...
@LPController(controllerkey="/FuKongJiLiangDian")
public class FuKongJiLiangDianController extends Controller {
	
	public void index() {
		renderTemplate("/org/zhutineirong/FuKongJiLiangDian_list.html");
	}
	...
	public void edit(){
		...
		renderTemplate("/sea3000/jiliangdian_fk.html");
	}
